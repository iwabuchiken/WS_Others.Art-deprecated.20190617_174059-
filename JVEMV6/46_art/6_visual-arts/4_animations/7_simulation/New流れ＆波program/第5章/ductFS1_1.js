...
function getVelocityParticle(pos)
{
  ...
  for(i = 0; i < NX; i++)
  {
	if(i * DX < pos.x && (i+1) * DX > pos.x) {I = i;break;}
  }
  for(j = 0; j < NY; j++)
  {
 	if(j * DY < pos.y && (j+1) * DY > pos.y) {J = j;break;}
  }
//if(J>=20 && J <= 25)console.log(" x = " + pos.x + " y = " + pos.y + " I = " + I + " J = " + J + " v.x = " + VelX[I][J] + " v.y = " + VelY[I][J]);
  var a =  pos.x / DX - I;
  var b =  pos.y / DY - J;
if(I > 20 && I < 25 && J>=20 && J <= 25)console.log("a = " +a + " b = " + b + " x = " + pos.x + " y = " + pos.y + " I = " + I + " J = " + J + " v.x = " + velX[I][J] + " v.y = " + velY[I][J]);
  //格子点の速度を線形補間
