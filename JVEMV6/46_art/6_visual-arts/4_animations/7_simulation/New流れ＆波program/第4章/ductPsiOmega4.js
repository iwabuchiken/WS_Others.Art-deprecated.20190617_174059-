...
function Rect()
{
  ...
  this.obs_nWY = 8; //障害物の幅(ｙ方向,格子間隔の整数倍)
}
var rect = new Rect();
var NX, NY, DX, DY;
...
function initData()
{
  ...
  var nMeshY1 = (NY - nObsWY) / 2;
  var nMeshY2 = (NY + nObsWY) / 2;
...
　//流線、等渦度線、圧力表示
  ...
  //障害物
  var x_obs = rect.left0.x + rect.obs_nX0 * DY * scale.x; 
  var y_obs = rect.left0.y + rect.size.y * scale.y / 2; 
