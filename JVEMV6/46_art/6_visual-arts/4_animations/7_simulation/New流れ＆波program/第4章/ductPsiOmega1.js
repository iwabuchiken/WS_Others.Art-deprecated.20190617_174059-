...
function Rect()
{
  ...
  this.left0 = new Vector3(-1, -1, 0);//その左下位置（canvas座標系）
  ...
  this.obs_left;//ダクト左端から障害物左端までの距離
}
var rect = new Rect();
var NX, NY, DX, DY;
...
//if(i > 20 && i < 50 && j > 20 && j < 40) 
//if(VelX[i][j] > 4 || VelY[i][j] > 4)
//console.log("i = " + i + " j = " + j + " vx = " + VelX[i][j] + " vy = " + VelY[i][j]);	  
